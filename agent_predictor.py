...
def evaluate_application(app):
    # App Structure: 0:AppID, 1:ReqAmount, 2:Income, 3:Score, 4:DTI, 5:Collateral, 6:AcctAge, 7:AvgTrans, 8:Priority, 9:Loyalty
...
def bootstrap_training(conn, model_path):
    ...
    # Select data: (AppID, ReqAmount, Income, Score, DTI, Collateral, AccountAge, AvgTrans, Priority, Loyalty)
    cursor.execute("""
        SELECT LA.ApplicationID, LA.RequestAmount, 
               FP.AnnualIncome, FP.CreditScore, FP.DebtToIncomeRatio, FP.CollateralValue,
